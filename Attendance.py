...
#     print("❌ Dataset feature size mismatch")
#     exit()

# print(f"✅ Training image size: {img_size} x {img_size}")
...
# # ================= ATTENDANCE SETTINGS =================
# COL_NAMES = ['Name', 'Time']
# ATTENDANCE_INTERVAL = 120  # 2 minutes (in seconds)
...
# ================= SETTINGS =================
ATTENDANCE_INTERVAL = 120      # 2 minutes
DISTANCE_THRESHOLD = 3500      # IMPORTANT (tune if needed)
